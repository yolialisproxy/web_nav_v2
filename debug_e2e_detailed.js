    ...
    for (let i = 0; i < 120; i++) { // 60 seconds max
        const status = await page.evaluate(() => {
            ...
            return ({
                ...
                dataManagerRawLength: window.dataManager ? (_b = window.dataManager.raw) === null || _b === void 0 ? void 0 : _b.length : -1,
                dataManagerSitesSize: window.dataManager ? (_c = window.dataManager.sites) === null || _c === void 0 ? void 0 : _c.size : -1,
                stateSitesLength: window.state ? (_d = window.state.get('sites')) === null || _d === void 0 ? void 0 : _d.length : -1,
    ...
    const finalState = await page.evaluate(() => {
        ...
        try {
            return {
                ...
                stateSitesLength: window.state ? (_c = window.state.get('sites')) === null || _c === void 0 ? void 0 : _c.length : -1,
...
//# sourceMappingURL=debug_e2e_detailed.js.map