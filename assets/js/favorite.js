...
class FavoriteManager {
    ...
    add(site) {
        ...
        const favoriteItem = Object.assign(Object.assign({}, site), { addedAt: new Date().toISOString(), favoriteId: this.generateId() });
    ...
    getByCategory() {
        ...
        Object.keys(grouped).forEach(cat => {
            grouped[cat].sort((a, b) => this._safeTimestamp(b.addedAt) - this._safeTimestamp(a.addedAt));
        });
        return grouped;
    }
    search(query) {
