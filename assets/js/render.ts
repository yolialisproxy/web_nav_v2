...
const renderer = {
    ...
    renderSidebar: function (s) {
        ...
        try {
            ...
            var activeCatId = (s === null || s === void 0 ? void 0 : s.get) ? s.get('sidebar.activeCategoryId') : null;
            if (activeCatId) {
                // 展开侧边栏
            ...
            // 设置活动的子分类（如果有）
            var activeSubId = (s === null || s === void 0 ? void 0 : s.get) ? s.get('sidebar.activeSubCategoryId') : null;
            if (activeSubId) {
    ...
    renderView: function (s) {
        try {
            var currentView = (s === null || s === void 0 ? void 0 : s.get) ? s.get('currentView') : 'grid';
            ...
            switch (currentView) {
                ...
                case 'list':
                    // 网格或列表视图 - 渲染站点
                    var sites = (s === null || s === void 0 ? void 0 : s.get) ? s.get('sites') : [];
                    if (currentView === 'list') {
                ...
                case 'search':
                    // 搜索视图
                    var query = (s === null || s === void 0 ? void 0 : s.get) ? s.get('search.query') : '';
                    var results = (s === null || s === void 0 ? void 0 : s.get) ? s.get('search.results') : [];
                    if (query.trim() !== '') {
                        ...
                        // 如果查询为空，显示分类视图
                        renderSites((s === null || s === void 0 ? void 0 : s.get) ? s.get('sites') : [], 'main-content');
                    }
                    break;
                case 'category':
                    // 分类视图
                    var catId = (s === null || s === void 0 ? void 0 : s.get) ? s.get('sidebar.activeCategoryId') : null;
                    var subId = (s === null || s === void 0 ? void 0 : s.get) ? s.get('sidebar.activeSubCategoryId') : null;
                    var leafId = (s === null || s === void 0 ? void 0 : s.get) ? s.get('sidebar.activeLeafId') : null;
                    if (catId) {
...
function renderOverlaySearchResults(results, query) {
    ...
    results.slice(0, 50).forEach(function (site) {
        var icon = '🌐';
        if (site.name && site.name.includes('GitHub'))
            icon = '🐙';
        else if (site.name && site.name.includes('AI'))
            icon = '🤖';
        else if (site.name && site.name.includes('Tool'))
            icon = '🔧';
        else if (site.name && site.name.includes('Design'))
            icon = '🎨';
    ...
    try {
        ...
        if (isSearch) {
            ...
            if (query && results && results.length > 0) {
                ...
                var container = document.getElementById('main-content');
                if (container)
                    container.innerHTML = StateUI.searchEmpty(query);
            }
            return;
        }
        // 分类视图
