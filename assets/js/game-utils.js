...
var GameUtils = {
    ...
    save: function (key, data) {
        try {
            localStorage.setItem('gn_game_' + key, JSON.stringify(data));
        }
        catch (e) { }
    },
    load: function (key) {
        try {
            return JSON.parse(localStorage.getItem('gn_game_' + key));
        }
        catch (e) {
            return null;
        }
    ...
    clear: function (key) {
        try {
            localStorage.removeItem('gn_game_' + key);
        }
        catch (e) { }
    },
    ...
    playSfx: function (key) {
        ...
        if (sfx)
            this.playSound(sfx.freq, sfx.duration, sfx.type);
    },
    toggleSound: function () {
        this.soundEnabled = !this.soundEnabled;
        try {
            localStorage.setItem('gn_sound_enabled', this.soundEnabled);
        }
        catch (e) { }
    },
